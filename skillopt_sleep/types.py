...
class SleepReport:
    ...
    n_replayed: int = 0
    miner_mode: str = ""
    llm_miner_attempted: bool = False
    sessions_passed_to_miner: int = 0
    llm_tasks_returned: int = 0
    llm_parse_failures: int = 0
    llm_empty_responses: int = 0
    llm_backend_errors: int = 0
    llm_uncheckable_candidates: int = 0
    llm_miner_error: str = ""
    fallback_used: bool = False
    n_checkable_tasks: int = 0
    n_checkable_val_tasks: int = 0
    n_pending_tasks: int = 0
    harvest_cursor_advanced: bool = False
    pre_gate_status: str = ""
